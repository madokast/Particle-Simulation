...
public class MagneticFieldColor extends Menu {
    private static MagneticFieldColor magneticFieldColor;
    public static MagneticFieldColor getInstance()
    {
        if(magneticFieldColor==null)
            magneticFieldColor = new MagneticFieldColor();

        return magneticFieldColor;
    }
