...
public class ReferredParticleTrackColor extends Menu {
    private static ReferredParticleTrackColor referredParticleTrackColor;
    public static ReferredParticleTrackColor getInstance()
    {
        if(referredParticleTrackColor==null)
            referredParticleTrackColor = new ReferredParticleTrackColor();

        return referredParticleTrackColor;
    }
    ...
    private ReferredParticleTrackColor()
    {
        super("Referred particle track");
